...
const initiatePayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.default.post(index_1.default.PAYMENT_URL, {
        ...
        success_url: `${index_1.default.SUCCESS_URL}/api/payment/confirmation?transactionId=${paymentData.transactionId}&status=success`,
        fail_url: `${index_1.default.BASE_URL}/api/payment/confirmation?transactionId=${paymentData.transactionId}&status=failure`,
        cancel_url: `${index_1.default.BASE_URL}`,
